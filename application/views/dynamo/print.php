    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-center">
            <img id="main_cover"src="assets/img/Work/dynamo/Print/1.jpg" style="max-width: 70%;" alt="">
    ...
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          ...
          <ul>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Print/1.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Print/2.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Print/3.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Print/4.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Print/5.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Print/6.jpg" /></li>
