    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/dynamo/Digital/1.png" style="max-width: 90%;" alt="">
...
<section id="work" style="padding:0px 0px 30px 0px !important; ">
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          <ul>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Digital/1.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Digital/2.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Digital/3.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Digital/4.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Digital/5.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Digital/6.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Digital/7.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Digital/8.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/dynamo/Digital/9.jpg" /></li>
