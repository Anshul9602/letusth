  ...
  <div class="container ">
    <div class="al">
      ...
      <div class="row d-flex justify-content-start" style="padding:60px 0px !important; ">
        <img id="main_cover" src="assets/img/Work/Mayur/Digital/Mockup_001.jpg" style="max-width: 90%;" alt="">
  ...
  <div class="container text-center">
    <div class=" thumbnails photos-list text-center ">
      <div class=" text-center">
        <ul>
          <li class="hidden"> <img src="assets/img/Work/Mayur/Digital/Work_001.jpg" /></li>
          <li class="hidden"> <img src="assets/img/Work/Mayur/Digital/Work_002.jpg" /></li>
          <li class="hidden"> <img src="assets/img/Work/Mayur/Digital/Mockup_001.jpg" /></li>
        </ul>
