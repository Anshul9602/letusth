    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/Mayur/Website_001.jpg" style="max-width: 90%;" alt="">
      ...
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          <ul>
            ...
            <li class="hidden"><img src="assets/img/Work/Mayur/Website_001.jpg" alt=""></li>
            <li class="hidden"><img src="assets/img/Work/Mayur/Website_002.jpg" alt=""></li>
            <li class="hidden"><img src="assets/img/Work/Mayur/Website_003.jpg" alt=""></li>
            <li class="hidden"> <img src="assets/img/Work/Mayur/Website_004.jpg" alt=""></li>
