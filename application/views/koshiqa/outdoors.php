    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/Koshiqa/Outdoor/Billboard.jpg" style="max-width: 90%;" alt="">
    ...
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" d-flex justify-content-center">
          <ul>
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Outdoor/Billboard.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Outdoor/Koshiqa_Match_Game.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Outdoor/Standee_003.jpg" /></li>
