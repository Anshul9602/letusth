    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-center">
            <img id="main_cover"src="assets/img/Work/Koshiqa/Print/Folded_Business_Card_Mockup_3.jpg" style="max-width: 70%;" alt="">
...
<section id="work" style="padding:0px 0px 30px 0px !important; ">
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          <ul>
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Print/Folded_Business_Card_Mockup_3.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Print/Koshika_Booklet_Print.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Print/Leaflet.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Print/Mockup_Koshiqa(1).jpg" /></li>
            
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Print/Statonary.jpg" /></li>
