    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/Koshiqa/Packaging/Boxes-Packaging-Mockup-PSD.jpg" style="max-width: 90%;" alt="">
    ...
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" d-flex justify-content-center ">
          <ul>
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Packaging/Boxes-Packaging-Mockup-PSD.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Koshiqa/Packaging/Koshika_Juice_Glass.jpg"  /></li>
          </ul>
