...
<section id="work" style="padding:20px 0px !important; ">
    <div class="container ">
      <div class="al">
        <h6></h6>
        <h1 style="font-size: 70px;">PRESS</h1>
        <div class="row d-flex justify-content-start" style="padding:60px 0px !important; ">
            <img id="main_cover" src="assets/img/Work/Cityvibes/Press/Newspaper_Mockup_001.jpg" style="max-width: 90%;" alt="">
...
<section id="work" style="padding:0px 0px 30px 0px !important; ">
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          <ul>
          <li class="hidden"> <img src="assets/img/Work/Cityvibes/Press/Newspaper_Mockup_001.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Cityvibes/Press/LUT_Company_Profile.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Cityvibes/Press/Cityvibes_Ad.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Cityvibes/Press/Cityvibes_FP.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Cityvibes/Press/Cityvibes_Half.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Cityvibes/Press/Cityvibes_Qtr.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Cityvibes/Press/Poster_001.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Cityvibes/Press/Poster_002.jpg" /></li>
