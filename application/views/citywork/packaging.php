    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/Cityvibes/Packaging/Kraft_Paper_Bag_001.jpg" style="max-width: 90%;" alt="">
...
<section id="work" style="padding:0px 0px 30px 0px !important; ">
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          <ul>
            <li class="hidden"> <img src="assets/img/Work/Cityvibes/Packaging/Dandiya_Box_Mockup.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Cityvibes/Packaging/Kraft_Paper_Bag_001.jpg" /></li>
          </ul>
