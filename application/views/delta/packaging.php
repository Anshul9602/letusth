    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/Delta/pack/Mockup_01.jpg" style="max-width: 90%;" alt="">
      ...
      <div class=" thumbnails photos-list text-center ">
        <div class=" d-flex justify-content-center">
          <ul>
            ...
            <li class="hidden"> <img src="assets/img/Work/Delta/pack/Mockup_01.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Delta/pack/Mockup_02.jpg"  /></li>
            <li class="hidden"> <img src="assets/img/Work/Delta/pack/Mockup_03.jpg"  /></li>
