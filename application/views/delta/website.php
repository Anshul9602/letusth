    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/Delta/4.jpg" style="max-width: 90%;" alt="">
      ...
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          <ul>
            ...
            <li class="hidden"><img src="assets/img/Work/Delta/4.jpg" alt=""></li>
            <li class="hidden"><img src="assets/img/Work/Delta/5.jpg" alt=""></li>
            <li class="hidden"><img src="assets/img/Work/Delta/6.jpg" alt=""></li>
            <li class="hidden"> <img src="assets/img/Work/Delta/7.jpg" alt=""></li>
