    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/Delta/digital/Delta_Callebaut_Mailer.png" style="max-width: 90%;" alt="">
      ...
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          <ul>
            ...
            <li class="hidden"> <img src="assets/img/Work/Delta/digital/Delta_Callebaut_Mailer.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/Delta/digital/Delta_Ravifruit_YUZU_Mailer.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/Delta/digital/1.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Delta/digital/2.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/Delta/digital/8.jpg" /></li>
          </ul>
