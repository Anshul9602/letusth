...
<section id="work" style="padding:20px 0px !important; ">
    <div class="container ">
      <div class="al">
        <h6></h6>
        <h1 style="font-size: 70px;">Merchandise</h1>
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/ch/mr/2.jpg" style="max-width: 90%;" alt="">
        ...
        <div class="  ">
          <ul>
           ...
           <div class=" col-lg-4"><img src="assets/img/Work/ch/5.jpg" alt=""><p>Mr & Mrs Mug_Golden Text_Mug_Mockup</p></div> -->
            <li class="hidden"><img src="assets/img/Work/ch/mr/1.jpeg" alt=""></li>
            <li class="hidden"><img src="assets/img/Work/ch/mr/2.jpg" alt=""></li>
            <li class="hidden"><img src="assets/img/Work/ch/mr/3.jpg" alt=""></li>
            <li class="hidden"> <img src="assets/img/Work/ch/mr/4.jpg" alt=""></li>
            <li class="hidden"> <img src="assets/img/Work/ch/mr/5.jpg" alt=""></li>
          </ul>
