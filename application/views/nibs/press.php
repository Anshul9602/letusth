...
<section id="work" style="padding:20px 0px !important; ">
    <div class="container ">
      <div class="al">
        <h6></h6>
        <h1 style="font-size: 70px;">SOCI</h1>
        <div class="row d-flex justify-content-start"style="padding:60px 0px !important; ">
            <img id="main_cover"src="assets/img/Work/nibs/Digital/3.jpg" style="max-width: 90%;" alt="">
...
<section id="work" style="padding:0px 0px 30px 0px !important; ">
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          <ul>
          <li class="hidden"> <img src="assets/img/Work/nibs/Digital/3.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Digital/4.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Digital/5.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Digital/6.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Digital/7.jpg" /></li>
