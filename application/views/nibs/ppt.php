    ...
    <div class="container ">
      <div class="al">
        ...
        <div class="row d-flex justify-content-center">
            <img id="main_cover"src="assets/img/Work/nibs/PPT/001.jpg" style="max-width: 70%;" alt="">
    ...
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          ...
          <ul>
            <li class="hidden"> <img src="assets/img/Work/nibs/PPT/001.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/PPT/002.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/PPT/003.jpg" /></li>
