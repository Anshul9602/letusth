...
<section id="work" style="padding:60px 0px !important; ">
    <div class="container ">
      <div class="al">
        <h6></h6>
        <h1 style="font-size: 70px;">PRINT</h1>
        <div class="row d-flex justify-content-center">
            <img id="main_cover"src="assets/img/Work/nibs/Print/1.jpg" style="max-width: 70%;" alt="">
    ...
    <div class="container text-center">
      <div class=" thumbnails photos-list text-center ">
        <div class=" ">
          ...
          <ul>
            <li class="hidden"> <img src="assets/img/Work/nibs/Print/1.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Print/2.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Print/3.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Print/7.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Print/4.png" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Print/5.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Print/6.jpg" /></li>
            <li class="hidden"> <img src="assets/img/Work/nibs/Print/8.jpg" /></li>
